...
#main
Matdata <- readMat('Fig2SMCSFglobalsignal.mat')
Rvalue <- Matdata$Fig2SMCSFglobalsignal
...
ggsave("Fig2SMCSFglobalsignal_FigS5c.png", plot = myplot, dpi=300, width = 5.50, height = 4.40)
