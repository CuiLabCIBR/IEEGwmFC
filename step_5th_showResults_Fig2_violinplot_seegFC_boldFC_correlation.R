#initiate set
rm(list = ls())
setwd('E:/WMseegBoldFCanalysis/CorrelationAnalysis/Fig2_results2fig')
library(ggplot2)
library(R.matlab)
library(ggsci)
library(tidyverse)
...
#main
Matdata <- readMat('Fig2_violinplot_SEEGFCBOLDFCspearman.mat')
Rvalue <- Matdata$Fig2
...
ggsave("Fig2_SEEGFC_BOLDFC_scatter.png", plot = myplot, dpi=300, width = 5.50, height = 4.40)
