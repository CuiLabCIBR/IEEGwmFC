...
#main
Matdata <- readMat('Fig2SMSEEGFCdistancespearman_FigS4.mat')
Rvalue <- Matdata$Fig2SMSEEGFCdistance
...
ggsave("Fig2SMSEEGFCdistancespearman_FigS4.png", plot = myplot, dpi=300, width = 5.50, height = 4.40)
